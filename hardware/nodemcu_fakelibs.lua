...
-- SJSON MODULE --
------------------
-- based: https://github.com/rxi/json.lua/blob/master/json.lua

sjson = {}

function sjson.encode(in_val)
  local encode
  ...
  return json_encode(in_val)
end

function sjson.decode(in_str)
  local parse
